...
async function fetchUrl(){
    ...
    const location = 'Cherapunji'

    const url = `https://api.weatherapi.com/v1/forecast.json?key=${key}&q=${location}&days=10`
    ...
    days.forEach((d, index) => {
        ...
        li.innerHTML = `
            ...
            <div class="eachDay">
                <h2 class="date">${li.id === 'cls-0' ? 'Today' : date.toLocaleString('en-US', {weekday: 'short'}) + ' ' + date.getDate()}</h2>
                ...
                <div class="degrees">
                    <span class="day-deg">${obj.dayTemp}<span>°</span></span>
